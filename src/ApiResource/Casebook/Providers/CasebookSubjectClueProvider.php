...
class CasebookSubjectClueProvider implements ProviderInterface
{
    public function __construct(
        private CasebookSubjectClueRepository $casebookSubjectClueRepository,
    ) {}
    ...
    public function provide(Operation $operation, array $uriVariables = [], array $context = []): object|array|null
    {
        ...
        if ($operation instanceof CollectionOperationInterface) {
            /**
             * @var array<CasebookSubjectClue> $clues
             */
            ...
            foreach ($clues as $clue) {
                $clueDto = CasebookSubjectClueDto::makeFromCasebookSubjectClue($clue);
                /*
                $subject = $this->casebookSubjectProvider->provide(new Get(), [
